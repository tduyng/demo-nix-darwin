...
alias nix-rebuild "sudo darwin-rebuild switch --flake ~/nix-darwin#aarch64-darwin --impure"
alias nix-rebuild-default "sudo darwin-rebuild switch --flake ~/nix-darwin#default --impure"
alias nix-check "sudo darwin-rebuild check --flake ~/nix-darwin#aarch64-darwin --impure"
